  ...
  return (
    ...
    <header style={masterHeader}>
      ...
      <div className='h-100 container'>
          ...
          <div className='col-8'>
            <h1 className='font-weight-ligth text-white '>{data.name}</h1>
    ...
    <div className='container'>
        ...
        <div className="form-group">
            ...
            <input type="text" value={form.comments} onChange={onChange('comments')} className="form-control" id="name" placeholder="Comentário sobre a Série"/>
        </div>
        <div className="form-group">
